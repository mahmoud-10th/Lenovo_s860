...
#lenovo-sw jixj 2013.9.13 add begin
MTXGEN_LOG   =  $(LOGDIR)/$(PROJECT)_mtxgen.log
#lenovo-sw jixj 2013.9.13 add end
...
ifeq ($(ENABLE_TEE), TRUE)
  ...
  #lenovo-sw jixj 2013.9.13 add begin
  DEAL_STDOUT_MTXGEN := 2>&1 | tee -a $(MTXGEN_LOG)
  #lenovo-sw jixj 2013.9.13 add end
  ...
  #lenovo-sw jixj 2013.9.13 add begin
  DEAL_STDOUT_MTXGEN  := > $(MTXGEN_LOG) 2>&1
  #lenovo-sw jixj 2013.9.13 add end
...
ANDROID_NATIVE_TARGETS += preloadimage
endif
...
#############################################################
# mtx.pl build
# lenovo-sw jixj 2013.9.13 add
#############################################################
mtxgen:
	##$(hide) perl mediatek/build/tools/Mtx/mtx.pl $(PROJECT) $(MTK_PLATFORM)
	$(hide) echo $(SHOWTIME) $@ing...
	$(hide) echo -e \\t\\t\\t\\b\\b\\b\\bLOG: $(S_LOG)$@.log
	perl mediatek/build/tools/Mtx/mtx.pl $(PROJECT) $(MTK_PLATFORM) 	$(DEAL_STDOUT_MTXGEN) && \
	$(SHOWRSLT) $${PIPESTATUS[0]} $(MTXGEN_LOG) ||  \
	$(SHOWRSLT) $${PIPESTATUS[0]} $(MTXGEN_LOG)
