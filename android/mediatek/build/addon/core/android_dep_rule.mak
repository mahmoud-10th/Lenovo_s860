...
ifeq ($(strip $(MTK_BSP_PACKAGE)),yes)
  ifneq ($(filter rel_customer_bsp, $(MTK_RELEASE_PACKAGE)),rel_customer_bsp)
     $(call dep-err-common, please add rel_customer_bsp in to MTK_RELEASE_PACKAGE When MTK_RELEASE_PACKAGE is yes)
  endif
endif
...
ifeq (yes, $(strip $(MTK_WORLD_PHONE)))
  ifeq (yes, $(strip $(GEMINI)))
    ifneq (1,$(strip $(MTK_GEMINI_SMART_3G_SWITCH)))
       $(call dep-err-common,When GEMINI & MTK_WORLD_PHONE both turn on MTK_GEMINI_SMART_3G_SWITCH only can be set 1)
    endif
  endif
endif
