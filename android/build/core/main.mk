...
ifneq (,$(user_variant))
  ...
  ifneq (true,$(DISABLE_DEXPREOPT))
    ...
    # Lenovo-sw wuzb1 2014-03-13 disable odex
...
ifeq (true,$(INSTALL_DEV_MODULES))
modules_to_install += $(call get-tagged-modules,dev)
endif
...
.PHONY: preloadimage
preloadimage: $(INSTALLED_PRELOADIMAGE_TARGET)
endif
...
ifeq ($(LENOVO_EASYIMAGE_ON),yes)
droidcore: $(INSTALLED_PRELOADIMAGE_TARGET)
endif
