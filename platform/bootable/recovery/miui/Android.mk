# lenovo-sw wangxf14 add 2013-06-20, add for button menu control file(miui_control_menu_buttonbox.c & miui_control_sd_buttonmenu.c)
# lenovo-sw wangxf14 add 2013-07-05, add for lenovo update textbox(miui_control_update_textbox.c)
...
LOCAL_CFLAGS += -DLENOVO_MULTI_STORAGE
endif
