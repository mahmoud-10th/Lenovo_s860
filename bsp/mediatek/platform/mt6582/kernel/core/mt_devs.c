...
extern unsigned int mtkfb_fb_lk_copy_size(void);
#else
...
//Lenovo-sw chenlj2 2014-01-02 hall add start
/*=======================================================================*/
/* hall sensor support                                            */
/*=======================================================================*/
...
#endif
//Lenovo-sw chenlj2 2014-01-02 hall add end
...
#if defined(BOSCH_BMA222EF_SENSOR)
static struct i2c_board_info __initdata bma_i2c_info={ I2C_BOARD_INFO("bma2xx", 0x18)};
#endif
...
//lenovo jixu add sn3193 leds 20131210
#if defined(LENOVO_SN3193_SUPPORT)
static struct platform_device sn3193_leds_device = {
	.name = "leds-sn3193",
	.id = -1
};
#endif
#if defined(LENOVO_SN3199_SUPPORT)
static struct platform_device sn3199_leds_device = {
	.name = "leds-sn3199",
	.id = -1
};
#endif
...
//Lenovo-sw chenlj2 2014-01-02 hall add start
#if defined(LENOVO_HALL_SENSOR_SUPPORT)
       printk(" register hall device enter\n");
	retval = platform_device_register(&hall_sensor_device);
	printk(" register hall device enter 1\n");
        if(retval != 0) {
             return retval;
        }
#endif
...
#if defined(BOSCH_BMA222EF_SENSOR)
	pr_err("xmr1: register bma_i2c_info bma222ef\n");
	i2c_register_board_info(2, &bma_i2c_info, 1);
#endif
...
//lenovo jixu add sn3193 leds 20131210
	...
	if (retval != 0)
		return retval;
	printk("[JX]:device sn3193_leds_device register\n");
#endif
#if defined(LENOVO_SN3199_SUPPORT)
	retval = platform_device_register(&sn3199_leds_device);
	if (retval != 0)
		return retval;
	printk("[JX]:device sn3199_leds_device register\n");
#endif
