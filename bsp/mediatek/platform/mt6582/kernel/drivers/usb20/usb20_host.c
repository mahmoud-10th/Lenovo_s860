...
void bq24196_set_otg_en( int en)
{
	bq24196_dump_register();	
    if(en){
#ifdef MTK_BQ27531_CONTROL_24196_SUPPORT
	bq27531_ctrl_enableotg();	
#else
         bq24196_set_chg_config(0x3); //OTG
#endif         
        // bq24196_set_boost_lim(0x0);//limit OTG out charging current 500mA
