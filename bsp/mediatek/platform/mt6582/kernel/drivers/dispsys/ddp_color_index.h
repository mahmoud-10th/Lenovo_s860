...
#include "ddp_drv.h"
//#define LENOVO_LCM_MULTI_GAMMA_PQ
#ifdef LENOVO_LCM_MULTI_GAMMA_PQ //lenovo.sw2 houdz 20130214 add:support  "Multi Gamma" and "PQ"function 
#if (CUSTOM_PQ_GAMMA_VER == project_stella)
#include "ddp_color_index_stella.h"
#endif 
#else
#define PQ_GAMMA_IDX_NUM    (1)
#define PQ_CUSTOM_PQPARAM_IDX_NUM    (1)

#define PQ_GAMMA_IDX_DEFAULT    "0"
...
#ifndef LENOVO_LCM_MULTI_GAMMA_PQ
