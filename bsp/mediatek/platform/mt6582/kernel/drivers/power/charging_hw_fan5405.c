...
//		if(charging_led_flag==1)
		{
			fan5405_config_interface(0x00, 0, 0x01, 6);
			charging_led_flag = 0;
		}
...
//		if(charging_led_flag==0)
		{
			fan5405_config_interface(0x00, 1, 0x01, 6);
			charging_led_flag = 1;
		}
...
static void hw_bc11_dump_register(void)
{
 ...
 static U32 hw_bc11_DCD(void)
 {
	 ...
	 //msleep(20);
/*lenovo-sw weiweij added for charger detect 20130806*/	 
//#ifndef LENOVO_CHARGING_STANDARD	
	 ...
	 mdelay(600);
#endif
/*lenovo-sw weiweij added  for charger detect 20130806 end*/
...
void lenovo_charging_term_set_stage_2(void)
{
	if(lenovo_charging_stage==1)
	{
		...
		fan5405_set_iterm(LENOVO_CHARGING_TERM_CUR_STAGE_2);
	}
}
...
{
	if(lenovo_charging_stage==1)
		fan5405_set_iterm(LENOVO_CHARGING_TERM_CUR_STAGE_1);//lenovo_charging_set_iterm(CHARGE_CURRENT_200_00_MA);
	else
		fan5405_set_iterm(LENOVO_CHARGING_TERM_CUR_STAGE_2);//lenovo_charging_set_iterm(CHARGE_CURRENT_150_00_MA);
}
#endif
...
/*lenovo-sw weiweij added for led control*/
//#ifndef LENOVO_CHARGING_STANDARD	
#if 0    
	fan5405_reg_config_interface(0x00,0xC0);	//kick chip watch dog
#else
   fan5405_config_interface(0x00, 0, 0x01, 7);	//kick chip watch dog
#endif
/*lenovo-sw weiweij added for led control end*/
