    ...
    switch(host->id){
        case 0:
            ...
            msdc_ldo_power(on, MT6323_POWER_LDO_VEMC_3V3, VOL_3300, &g_msdc0_flash);
                        //lenovo-sw yexh1 2013_12_06 add power on delay for Phaeton Prj's Hynix eMMC H9TP18A8JDMCPR_KGM to solve CMD data CRC error.
                        mdelay(10);
                        //lenovo-sw yexh1 2013_12_06 end
            break;
#if (0 == REMOVEED_FOR_MT6582)
        case 4:
            msdc_set_smt(host,1);
