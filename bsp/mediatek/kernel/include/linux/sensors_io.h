...
/* Merge from VT58, Start */
#define ALSPS_IOCTL_SET_CALI                _IOW(ALSPS, 0x0a, int)
#define ALSPS_SET_PS_PCOUNT                 _IOW(ALSPS, 0x0b, int)
#define ALSPS_SET_PS_POFFSET                 _IOW(ALSPS, 0x0c, int)  /*Colby add 20121218*/
/* Merge from VT58, End */
#define ALSPS_SET_AUTO_CALI                 _IOW(ALSPS, 0x0d, int)  /*Colby add 20130111*/
#define ALSPS_SET_THD                 _IOW(ALSPS, 0x0e, int) /*add for FTM interrupt check 20130416*/
#define ALSPS_GET_INTERRUPT_COUNT     _IOR(ALSPS, 0x0f, int) /*add for FTM interrupt check 20130416*/
#define ALSPS_IOCTL_ALS_CALI     _IOR(ALSPS, 0x10, int)
