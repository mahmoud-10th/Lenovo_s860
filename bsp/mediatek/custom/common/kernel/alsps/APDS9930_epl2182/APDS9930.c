...
/*  update lux convert algo from avago FAE --liaoxl.lenovo start */
	...
	/*lenovo sw molg1 add for auto_brightness issue with flip-cover 20130808  begin*/
	if(1 == atomic_read(&obj->als_suspend))
	{
		return -1;
	}
	/*lenovo sw molg1 add for auto_brightness issue with flip-cover 20130808  end*/
	...
	APS_LOG("APDS9930_read_als get ch0=%d ch1=%d ret=%d\n", ch0data, ch1data, luxValue);
