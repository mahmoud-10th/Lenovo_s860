...
#define APP_BL_MIN 1
#define APP_BL_DEFAULT 102
#define APP_BL_MAX 255
#endif
...
typedef struct
{
	...
	unsigned int 		hs_read;//lenovo add by jixu@lenovo.com
} LCM_DSI_PARAMS;
...
typedef struct
{
	...
	////lenovo add begin by jixu@lenovo.com
	LCM_BL_LEVELS bl_app;
	LCM_BL_LEVELS bl_bsp;
	////lenovo add end by jixu@lenovo.com
} LCM_PARAMS;
...
typedef struct
{
    ...
    */
    ...
    void (*dsi_set_cmdq_V4)(unsigned int *pdata, unsigned int queue_size, unsigned char force_update);//lenovo add by jixu@lenovo.com
...
typedef struct
{
	...
	////lenovo add begin by jixu@lenovo.com
		...
		const char* version;//lenovo jixu add
