...
#define C_CUST_PS_CALI_LEVEL    10
...
struct alsps_hw {
	...
	unsigned int    ps_level[C_CUST_PS_CALI_LEVEL]; 
	unsigned int    ps_close_value[C_CUST_PS_CALI_LEVEL];   
	unsigned int    ps_far_value[C_CUST_PS_CALI_LEVEL]; 
	unsigned int    ps_min_diff;   			/*used for minux value between near ps level*/
