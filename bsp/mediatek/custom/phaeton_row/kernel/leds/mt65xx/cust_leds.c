...
#ifdef LENOVO_LCD_BACKLIGHT_COMPATIBLE_SUPPORT//lenovo add by jixu@lenovo.com
...
#ifndef MT_LED_INTERNAL_LEVEL_BIT_CNT
#define MT_LED_INTERNAL_LEVEL_BIT_CNT 10
#endif //MT_LED_INTERNAL_LEVEL_BIT_CNT
#endif //LED_INCREASE_LED_LEVEL_MTKPATCH
unsigned int Cust_SetBacklight(int level, int div)
{
	if(DISP_IsLcmBacklight())
	    mtkfb_set_backlight_level(level);
	else
		disp_bls_set_backlight((((1 << MT_LED_INTERNAL_LEVEL_BIT_CNT) - 1)*level + 127)/255);
