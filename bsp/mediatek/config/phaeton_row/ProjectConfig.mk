...
#Lenovo-sw chenglong1 modify for phaeton
...
CUSTOM_HAL_IMGSENSOR = ov8865_mipi_raw ov9760_mipi_raw
...
#Lenovo-sw chenglong1 modify for ov8825
...
#lenovo-sw chenglong1 add for phaeton
...
#lenovo-sw chenglong1 2013-10-15 modify for flash driver begin
...
CUSTOM_KERNEL_IMGSENSOR = ov8865_mipi_raw ov9760_mipi_raw
#lenovo-sw add end
...
CUSTOM_LK_LCM=otm1283a_hd720_dsi_vdo_boe nt35520_hd720_dsi_vdo_cpt
...
#lenovo-sw chenjian2 modify on 20140106 for InputMethod
...
#lenovo-sw zhouwl, 2014-02-28, disable this feature
...
# liubin modified 2014.01.07, disable MAP profile
...
# liubin modified 2014.01.07, disable Proximity profile
...
# liubin modified 2014.01.07, disable SIMAP profile
...
MTK_BQ24250_SUPPORT = no
MTK_BQ24196_SUPPORT=yes
HIGH_BATTERY_VOLTAGE_SUPPORT = yes
LENOVO_H_CHARGER=yes
#lenovo-sw weiweij modified for bq24250 support end
...
#lenovo-sw zhouwl, 2014-03-26, config for s860
...
MTK_M4U_SUPPORT=yes
#lenovo-sw yexh1 2014_01_22modify for Let persist.sys.usb.config in default.prop as MTP
...
#Begin, lenovo-sw wangxf14 modify, modify for no extern sdcard
...
#End, lenovo-sw wangxf14 modify, modify for no extern sdcard
...
#Lenovo-sw wuzb1 2013-10-02 disable permission control with LenovoSafeCenter
...
#Begin, lenovo-sw wangxf14 modify 20140109, add lenovo fuse feature
LENOVO_SHARED_SDCARD = yes
#End, lenovo-sw wangxf14 modify 20140109, add lenovo fuse feature
...
#Lenovo-sw linyf jixj 2014-01-07 12:18 , enable common slot func.
...
#lenovo-sw chenjian2 modify on 20140109
...
# Lenovo-sw wuzb1 204-03-21 enable CU
...
#Begin, lenovo-sw wangxf14 note
RESOURCE_OVERLAY_SUPPORT=generic sd_in_otg
#End, lenovo-sw wangxf14 note
...
#lenovo-sw zhangjiano add for flash driver
FLASH_BD7710 = yes
FLASH_RT9387 = no
# Define which modem will be used.
#lenovo-sw jixj 2014.3.27 modfied
#CUSTOM_MODEM=mt6582_demo_hspa_sky_18
CUSTOM_MODEM=mt6582_demo_hspa_phaeton_row
...
CUSTOM_KERNEL_LCM=otm1283a_hd720_dsi_vdo_boe nt35520_hd720_dsi_vdo_cpt

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=otm1283a_hd720_dsi_vdo_boe nt35520_hd720_dsi_vdo_cpt
...
# lenovo-sw chenjian2 modify on 20140227
#MTK_PRODUCT_LOCALES=en_US zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR pl_PL es_US bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE en_GB
MTK_PRODUCT_LOCALES=en_US es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR hdpi xhdpi
...
#CREATE_PROJECT_INFO=2014022018120
MTK_BUILD_VERNO = ALPS.KK1.MP1.V2.10

#lenovo yexh1 add begin
LENOVO_PRODUCT_DEVICE = S860
#lenovo yexh1 end

#modified by lenovo-xm.chenyb1
LENOVO_STD_LINECTL_EARPHONE = yes

#lenovo jixu add sn319x rgb led
LENOVO_SN3193_SUPPORT = no
LENOVO_SN3199_SUPPORT = no

#Lenovo-sw liaohj add, 2013-11-01
LENOVO_POWEROFF_CHARGING_UI = yes

#Lenovo-sw chenlj2 hall add
LENOVO_HALL_SENSOR_SUPPORT = no

#Begin, lenovo-sw wangxf14 20140109 add, add for lenovo recovery
LENOVO_RECOVERY_SUPPORT = yes
#End, lenovo-sw wangxf14 20140109 add, add for lenovo recovery

#Begin, lenovo-sw wangxf14 20140521 add, add for lenovo recovery factory powerdown
LENOVO_FACTORY_WIPE_DATA_SHUTDOWN = yes
#End, lenovo-sw wangxf14 20140521 add, add for lenovo recovery factory powerdown
...
#lenovo-sw xuwen1 20140106 begin
LENOVO_CTP_SLIDE_WAKEUP = yes
LENOVO_AREA_TOUCH = yes
NEED_TO_CREAT_LIMIT = yes
#lenovo-sw xuwen1 20140106 end

#lenovo-sw zhouwl 2014-01-06 for audio DRC2.0
DRC_2_0_SPK_EARPHONE_SUPPORT = no
#lenovo-sw zhouwl 2014-01-06 for audio DRC2.0

#lenovo-sw chenyb1 2014.1.16 add begin
LENOVO_LOWBAT_PWROFF_ALARM = no
#lenovo-sw chenyb1 2014.1.16 add end
#lenovo-sw jixu add begin
LENOVO_LCD_BACKLIGHT_CONTROL_BY_LCM = yes
LENOVO_LCD_BACKLIGHT_COMPATIBLE_SUPPORT = no
#lenovo-sw jixu add end
LENOVO_VIBR_VOL_MAX = yes
#lenovo-sw jixu add for backlight limit in bsp
LENOVO_BACKLIGHT_LIMIT = yes
#lenovo-sw jixu add end
#lenovo-sw chenyb1 add for tp good experience with cpu high performance
LENOVO_CPU_INPUT_BOOST_HIGH_PERF = yes
#lenovo-sw chenyb1 add end
#lenovo-sw wengjun1 2013-11-20 add add for tp dma transfer begin
LENOVO_CTP_FW_UPDATE = no
LENOVO_CTP_GLOVE_CONTROL = yes
LENOVO_CTP_GLOVE_SENSIBILITY = yes
LENOVO_CTP_DMA_CONTROL = yes
LENOVO_AREA_TOUCH = yes
#lenovo-sw wengjun1 2013-11-20 add add for tp dma transfer end

#lenovo-sw lixh10 2014.4.9 add add turn down the vibrator begin
LENOVO_VIBR_VOL_PHAETON = yes
#lenovo-sw lixh10 2014.4.9 add add turn down the vibrator end
#
#lenovo-sw zhouwl, 20131002, add for nxp-tfa9887
LENOVO_NXP_SMARTPA_SUPPORT=yes
#lenovo-sw zhouwl, 20131119, use rec in dual-mic test avoid "Bee~" tone
LENOVO_DUALMIC_USE_REC=yes
#lenovo-sw zhouwl, 20140326, use ref-mic when handfree call for s860
LENOVO_PHAETON_HANDFREE_CALL=yes
#lenovo-sw zhouwl, 20140326, add earphone pa
LENOVO_USE_HPTPA6136_CODEC=yes
#lenovo-sw molg1 add 20140327 begin
BOSH_BMC056_SENSOR = yes
#lenovo-sw molg1 add 20140327 begin
MTK_LENOVO_VCE_SUPPORT = yes
MTK_LENOVO_REC_QUALITY_SUPPORT = no
MTK_LENOVO_LEMETTING_SUPPORT = no
MIN_MATCH_IDEAFRIEND_OVERSEA = yes
